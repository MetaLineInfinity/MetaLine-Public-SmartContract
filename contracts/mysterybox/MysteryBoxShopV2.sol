...
// Metaline Contracts (MysteryBoxShopV1.sol)
    ...
    AccessControl
{
    ...
    function buyMysteryBox(string calldata pairName) external payable lock whenNotPaused {
        OnSaleMysterBox storage onSalePair = _onSaleMysterBoxes[pairName];
        OnSaleMysterBoxRunTime storage onSalePairData = _onSaleMysterBoxDatas[pairName];
    ...
    function batchBuyMysterBox(string calldata pairName, uint32 count) external payable lock whenNotPaused {
