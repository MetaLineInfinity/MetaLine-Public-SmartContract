...
// see {UniswapERC20}
abstract contract PortMarketPairERC20 is ProxyImplInitializer {
    ...
    function __chain_initialize_PortMarketERC20 () internal onlyInitializing {
        uint chainId;
        assembly {
            chainId := chainid()
        }
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'PortMarket: INVALID_SIGNATURE');
