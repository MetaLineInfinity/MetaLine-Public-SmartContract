...
library OracleCharger_V1 {
    ...
    function charge(OracleChargerStruct storage charger, string memory tokenName, uint256 usdValue, address receiveAddr) 
        internal lock(charger) returns(uint256 tokenCost) 
    {
        ...
        tokenCost = usdValue * 10**tokenSet.decimals / tokenUSDPrice;
        ...
        if(tokenSet.tokenAddr == address(0)){
            ...
            TransferHelper.safeTransferFrom(tokenSet.tokenAddr, msg.sender, receiveAddr, tokenCost);
        }
    }
