...
describe("mystery box shop v1 Test", function () {
    before(inittest);
...
async function inittest() {
    ...
    MysteryBoxShopV1 = ContractInfo.getContract("MysteryBoxShopV1");
    ...
    await ContractTool.CallState(MysteryBoxShopV1,"setOnSaleMysteryBox",["testpair",saleconfig,[100,10000]]);
...
async function buymb() {
    ...
    await ContractTool.CallState(MockERC20, "approve", [MysteryBoxShopV1.address, 10000]);

    logtools.loggreen("erc20=" + v);
    await ContractTool.CallState(MysteryBoxShopV1, "buyMysteryBox", ["testpair"]);
...
async function buymb_batch() {
    ...
    logtools.loggreen("erc20=" + v);
    await ContractTool.CallState(MysteryBoxShopV1, "batchBuyMysterBox", ["testpair", 10]);
